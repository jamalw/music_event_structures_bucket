...
wva_dir = datadir + 'prototype/link/scripts/hmm_K_sweep_paper_results/Schaefer' + str(parcelNum) + '/allROIs/'

savedir = datadir + 'prototype/link/scripts/hmm_K_sweep_paper_results/Schaefer' + str(parcelNum) + '/'
