...
datadir = '/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/HMM_searchlight_bound_match_shuffle_event_lengths_rotation/'
...
for i in range(len(songs)):
    fn_z = glob.glob(datadir + songs[i] + '/perms/globals_avg_both_perms_runs_n25_srmk_30.npy')
    data = np.load(fn_z[0])
