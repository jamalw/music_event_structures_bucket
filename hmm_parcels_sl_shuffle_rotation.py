...
if runNum == 0:
    pfn = savedir + "/pvals_srm_v1_test_run1_shuffle_rotation_split_merge_original_match_score"
    zfn = savedir + "/zscores_srm_v1_test_run1_shuffle_rotation_split_merge_original_match_score"
    mfn = savedir + "/match_scores_srm_v1_test_run1_shuffle_rotation_split_merge_original_match_score"
elif runNum == 1:
    pfn = savedir + "/pvals_srm_v1_test_run2_shuffle_rotation_split_merge_original_match_score"
    zfn = savedir + "/zscores_srm_v1_test_run2_shuffle_rotation_split_merge_original_match_score"
    mfn = savedir + "/match_scores_srm_v1_test_run2_shuffle_rotation_split_merge_original_match_score"
