...
for i in range(len(k)):
    ...
    img.header['cal_min'] = minval
    img.header['cal_max'] = maxval
    nib.save(img,'/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/HMM_searchlight_K_sweep_srm/avg_z_k' + str(k[i]) +'_across_songs.nii.gz')
...
for i in range(len(k)):
    ...
    img.header['cal_min'] = minval
    img.header['cal_max'] = maxval
    nib.save(img,'/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/HMM_searchlight_K_sweep_srm/avg_real_k' + str(k[i]) +'_across_songs.nii.gz')
