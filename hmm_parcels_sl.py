...
savedir = "/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/parcels/Schaefer100/" + songs[idx]
...
if runNum == 0:
    pfn = savedir + "/pvals_srm_off_run1"
    mfn = savedir + "/match_scores_srm_off_run1"
elif runNum == 1:
    pfn = savedir + "/pvals_srm_off_run2"
    mfn = savedir + "/match_scores_srm_off_run2"
