...
np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/HMM_searchlight_bound_match_shuffle_event_lengths/' + songs[song_idx] +'/raw/globals_raw_srm_k_' + str(srm_k) + '_train_run2', results3d_real)
np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/HMM_searchlight_bound_match_shuffle_event_lengths/' + songs[song_idx] +'/zscores/globals_z_srm_k' + str(srm_k) + '_train_run2', results3d)
np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/HMM_searchlight_bound_match_shuffle_event_lengths/' + songs[song_idx] +'/perms/globals_z_srm_k' + str(srm_k) + '_train_run2', results3d_perms)
