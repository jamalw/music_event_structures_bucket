...
for b in range(nboot):
        ...
        run1_resample_avg = np.mean(run1_resample,axis=2)
        run2_resample_avg = np.mean(run2_resample,axis=2)
	##################################################################################
...
np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/hmm_K_sweep_paper_results/principled/bil_A1_no_srm_ver2_wva_split_merge_01_' + str(bootNum), wVa_results)
