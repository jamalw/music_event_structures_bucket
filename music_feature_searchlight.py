...
if runNum == 0:
    ...
    song_features = np.load(datadir + 'prototype/link/scripts/data/searchlight_input/torusRun1_hrf_34.npy')
    ...
    song_features = np.load(datadir + 'prototype/link/scripts/data/searchlight_input/torusRun2_hrf_34.npy')
...
if runNum == 0:
    np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/music_features/' + songs[song_idx] +'/torus/raw/globals_raw_srm_k_' + str(srm_k) + '_test_run1', results3d_real)
    np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/music_features/' + songs[song_idx] +'/torus/zscores/globals_z_srm_k' + str(srm_k) + '_test_run1', results3d)
    np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/music_features/' + songs[song_idx] +'/torus/perms/globals_z_srm_k' + str(srm_k) + '_test_run1', results3d_perms)
if runNum == 1:
    np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/music_features/' + songs[song_idx] +'/torus/raw/globals_raw_srm_k_' + str(srm_k) + '_test_run2', results3d_real)
    np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/music_features/' + songs[song_idx] +'/torus/zscores/globals_z_srm_k' + str(srm_k) + '_test_run2', results3d)
    np.save('/jukebox/norman/jamalw/MES/prototype/link/scripts/data/searchlight_output/music_features/' + songs[song_idx] +'/torus/perms/globals_z_srm_k' + str(srm_k) + '_test_run2', results3d_perms)
