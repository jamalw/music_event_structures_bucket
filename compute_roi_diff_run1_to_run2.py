...
# plot avg match scores for run 1 and run 2
run_means = [voxels_by_songs_run1.mean(), voxels_by_songs_run2.mean()]
run_stds = [voxels_by_songs_run1.std(), voxels_by_songs_run2.std()]

plt.bar(np.arange(2),run_means, yerr=run_stds) 
