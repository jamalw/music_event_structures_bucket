...
if runNum == 0:
    pfn = savedir + "/pvals_srm_v1_test_run1_shuffle_rotation_split_merge_original_match_score_regress_all_features"
    zfn = savedir + "/zscores_srm_v1_test_run1_shuffle_rotation_split_merge_original_match_score_regress_all_features"
    mfn = savedir + "/match_scores_srm_v1_test_run1_shuffle_rotation_split_merge_original_match_score_regress_all_features"
elif runNum == 1:
    pfn = savedir + "/pvals_srm_v1_test_run2_shuffle_rotation_split_merge_original_match_score_regress_all_features"
    zfn = savedir + "/zscores_srm_v1_test_run2_shuffle_rotation_split_merge_original_match_score_regress_all_features"
    mfn = savedir + "/match_scores_srm_v1_test_run2_shuffle_rotation_split_merge_original_match_score_regress_all_features"
